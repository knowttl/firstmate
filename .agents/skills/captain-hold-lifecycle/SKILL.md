...
description: >-
  ...
  Load before treating an investigation, scout report, structured review, or Atelier review as complete, before ending a visual review that exposed a captain decision, when recording or routing the captain's answer, and on any RECORD DIVERGENCE line the wake drain prints.
