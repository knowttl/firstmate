...
`bin/fm-procevent.sh --help`, `bin/fm-procevent-atelier.sh --help`, `bin/fm-procevent-when.sh --help`, and `bin/fm-procevent-remote-reply.sh --help` own the exact commands and flags.
