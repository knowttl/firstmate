...
description: >-
  ...
  boundary, and the Atelier adapter's loss limitation.
...
`bin/fm-procevent.sh --help`, `bin/fm-procevent-atelier.sh --help`, and `bin/fm-procevent-remote-reply.sh --help` own the exact commands and flags.
