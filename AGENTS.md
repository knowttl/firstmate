...
Keep `local-only` work in the main home.
Send in-scope work to the fitting secondmate, including authorized later phases under section 10's filing rule, unless the captain explicitly redirects it; do not read the secondmate's chat because marked routed replies return through its status or referenced document.
