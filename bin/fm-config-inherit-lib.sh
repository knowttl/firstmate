...
# hand-edit backlog files too, and primary config/review-tool=atelier-axi makes
# that home's toolchain check resolve the same rich-review tool).
#
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness backlog-backend review-tool}"
