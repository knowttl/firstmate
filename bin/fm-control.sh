...
#              plus its optional model and effort tokens), or its per-secondmate
#              override config/secondmate-harness.<id> when present, exactly as
#              any other respawn does, while a ship or scout keeps the exact
