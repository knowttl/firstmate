...
#                          of the worker or its tool process. That wedge timer is
#                          exempt from the working deferral above: the busy signal
#                          a re-verification would read is the very one
