...
FM_INJECT_MAX_BYTES=1000           # byte budget for one injected digest; oldest events go first, an event too long to fit alone is truncated with its status-log path, and the rest wait for later batches
