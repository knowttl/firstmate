...
| `fm-ready-work.sh`       | Surface queued backlog work that became ready without this home acting, once per readiness transition, and count live-gated queued work as supervision need |
