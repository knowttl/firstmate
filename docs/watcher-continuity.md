...
The reuse-only publication rechecks that beacon inside the marker-lock critical section and skips a new episode only while it remains fresh; any indeterminate scan or health proof falls back to ordinary downtime publication.
